...
.then(data =>{
   ...
   let rapportIndexArray = new Array();
      ...
      if (!rapportIndexArray.includes(data[index]['auto_id'])  && index == lastRapportId(data[index]['auto_id'], data) &&  (data[index]['statut_fonctionnement'].toLowerCase().localeCompare("en service") == 0)){
